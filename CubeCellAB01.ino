...
static u1_t APPEUI[8] = { 0x60, 0x81, 0xF9, 0xA1, 0x8A, 0xEB, 0x6xxxxxxxx }; 
static u1_t DEVEUI[8] = { 0x60, 0x81, 0xF9, 0x2B, 0x8A, 0x3C, 0xxxxxx};
static u1_t APPKEY[16] = { 0xE2, 0x08, 0x00, 0x8B, 0x95, 0xDE, 0x7C, 0x72, 0xFD, 0xEA, 0x9B, 0x3C, 0xxxx };
